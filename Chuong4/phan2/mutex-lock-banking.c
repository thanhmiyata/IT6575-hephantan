...
void * transactions(void * args){
    ...
    for(i = 0; i < NUM_TRANS; i++){
        ...
        // Lock trước khi vào critical section
        ...
        // Unlock sau khi ra khỏi critical section
...
int main(int argc, char * argv[]){
    ...
    printf("=== CÂU HỎI 7: BANKING WITH MUTEX LOCK ===\n");
    ...
    if(difference != 0){
        ...
        printf("✓ Mutex lock hoạt động tốt!\n");
    }
